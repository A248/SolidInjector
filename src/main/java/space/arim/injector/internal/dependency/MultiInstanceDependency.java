...
public final class MultiInstanceDependency<T> implements InstantiableDependency {

	private final Identifier<T> identifier;

	public MultiInstanceDependency(Identifier<T> identifier) {
	...
	public boolean equals(Object o) {
		...
		MultiInstanceDependency<?> that = (MultiInstanceDependency<?>) o;
